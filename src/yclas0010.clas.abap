...
public section.
  ...
  interfaces ZIF_ABAPGIT_2FA_AUTHENTICATOR .

  aliases AUTHENTICATE
    for ZIF_ABAPGIT_2FA_AUTHENTICATOR~AUTHENTICATE .
  aliases BEGIN
    for ZIF_ABAPGIT_2FA_AUTHENTICATOR~BEGIN .
  aliases DELETE_ACCESS_TOKENS
    for ZIF_ABAPGIT_2FA_AUTHENTICATOR~DELETE_ACCESS_TOKENS .
  aliases END
    for ZIF_ABAPGIT_2FA_AUTHENTICATOR~END .
  aliases IS_2FA_REQUIRED
    for ZIF_ABAPGIT_2FA_AUTHENTICATOR~IS_2FA_REQUIRED .
  aliases SUPPORTS_URL
    for ZIF_ABAPGIT_2FA_AUTHENTICATOR~SUPPORTS_URL .
  ...
  methods CONSTRUCTOR
    importing
      !IV_SUPPORTED_URL_REGEX type CLIKE .
  PROTECTED SECTION.
    CLASS-METHODS:
...
CLASS YCLAS0010 IMPLEMENTATION.
